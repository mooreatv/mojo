...
const wchar_t * g_apDefaultScribs [] =
{
   ...
   L"DlgSettingsAppearance.ToonIcon.Label                   = Toon icons",
   L"DlgSettingsAppearance.ToonIconHeightLabel              = Height",
   L"DlgSettingsAppearance.ToonIconWidthLabel               = Width",
   L"DlgSettingsAppearance.Link                             = <a href=\"%s\">Learn more about these choices</a>",
   L"DlgGetTrigger.Link                                     = <a href=\"%s\">Learn more about hotkey triggers</a>",
   0
};
