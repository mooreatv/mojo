...
const wchar_t * g_apDefaultScribs [] =
{
   ...
   L"DlgAbout          = Copyright 2009-2010 Robert Sacks",
   ...
   L"DlgFigWoW.Link                                         = <a href=\"%s\">Learn more about WoW properties</a>",
   L"DlgFigPredefinedHotkeys.Link                           = <a href=\"%s\">Learn more about predefined hotkeys</a>",
   L"DlgSettingsActiveWindowTracking.Link                   = <a href=\"%s\">Learn more about active window tracking</a>",
   0
};
